 ...
 */
public enum Permission implements OptionList {
  CourseLocation("ACCESS_COURSE_LOCATION"),
  ...
  static {
    for(Permission perm : Permission.values()) {
      lookup.put(perm.getValue(), perm);
    }
  }

  public static Permission get(String perm) {
